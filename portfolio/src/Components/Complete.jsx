  ...
  return (
    <div className="flex w-full justify-center  mt-6">
      <div className="  sm:w-full sm:flex sm:justify-end leading-none pr-2 scroll-smooth">
        <div className="w-[250px] sm:w-[500px] sm:h-[300px] h-[150px] border-2 rounded-md px-1 py-2 bg-slate-200">
          <Link to={props.link}>
          <div className="w-full h-[150px] sm:h-[220px] rounded-md bg-gradient-to-r from-slate-300 to-slate-500">
            <img
